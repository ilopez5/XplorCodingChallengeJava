...
public final class UnitTests {
    ...
    public void testCaseOne() {
        ...
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(visa) == 10); //interest per card

        var mc = new MastercardCard("5123-1234-1234-1234", "212", 100, mcInterest);
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(mc) == 5); //interest per card

        var discover = new DiscoverCard("6011-1234-1234-1234", "313", 100, discoverInterest);
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(discover) == 1); //interest per card
        ...
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(person.getWallets()) == 16); //interest per person
    }
    ...
    public void testCaseTwo() {
        ...
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(walletOne) == 11); //interest per wallet

        var walletTwo = new Wallet();
        walletTwo.addCard(new MastercardCard("5234-2345-2345-2345", "313", 100, mcInterest));
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(walletTwo) == 5); //interest per wallet
    ...
    public void testCaseThree() {
        ...
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(walletOne) == 15); //interest per wallet
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(personOne.getWallets()) == 15); //interest per person
        ...
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(walletTwo) == 15); //interest per wallet
        Assert.assertTrue(InterestCalculator.calculateSimpleInterest(personTwo.getWallets()) == 15); //interest per person
    }
